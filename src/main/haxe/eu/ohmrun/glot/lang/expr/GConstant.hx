...
@:using(eu.ohmrun.glot.lang.expr.GConstant.GConstantLift)
...
class GConstantLift{
  ...
  //       e.Path('eu.ohmrun.glot.lang.expr.GConstant.GConstantSum.GCInt'),[
  ...
  //     case GCFloat(f, s)     : 
  //       e.Call(
  //         e.Path('eu.ohmrun.glot.lang.expr.GConstant.GConstantSum.GCFloat'),[
  //           e.Const(c -> c.String(v)),
  //           __.option(s).fold(
  //             ok -> e.Const(c -> c.String(ok)),
  //             () -> e.Const(c -> c.Ident('null'))
  ...
  //       e.Call(
  //         e.Path('eu.ohmrun.glot.lang.expr.GConstant.GConstantSum.GCString'),
  //         [e.Const(c -> c.String(s)),kind.spell()]
  //       );
  //     case GCIdent(s)        : 
  //       e.Call(
  //         e.Path('eu.ohmrun.glot.lang.expr.GConstant.GConstantSum.GCIdent'),
  //         [e.Const(c -> c.String(s))]
  //       );
  //     case GCRegexp(r, opt)  : 
  //       e.Path('eu.ohmrun.glot.lang.expr.GConstant.GConstantSum.GCRegexp'),
  //       [
  //         e.Const(c -> c.String(v)),
