...
@:using(eu.ohmrun.glot.lang.expr.GExpr.GExprLift)
...
class GExprLift{
  ...
  //     case GEConst(c)                     : 
  //       e.Call(
  //         e.Path('eu.ohmrun.glot.lang.expr.GExpr.GExprSum.GEConst'),
  //         [
  //           c.spell()
  //         ]
  //       );
  //     case GEArray(e1, e2)                : 
  //       e.Call(
  //         e.Path('eu.ohmrun.glot.lang.expr.GExpr.GExprSum.GEArray'),
  //         [
  //           e1.spell(),
  //           e2.spell()
  //         ]
