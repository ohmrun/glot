...
class Lang{
  static public function g(wildcard:Wildcard){
    return new eu.ohmrun.glot.lang.Module();  
  }
}
...
typedef GAccess             = eu.ohmrun.glot.lang.expr.GAccess;
typedef GAccessSum          = eu.ohmrun.glot.lang.expr.GAccess.GAccessSum;
typedef GAccessCtr          = eu.ohmrun.glot.lang.expr.GAccess.GAccessCtr;

typedef GBinop              = eu.ohmrun.glot.lang.expr.GBinop;
typedef GBinopSum           = eu.ohmrun.glot.lang.expr.GBinop.GBinopSum;

typedef GCase               = eu.ohmrun.glot.lang.expr.GCase;
typedef GCaseDef            = eu.ohmrun.glot.lang.expr.GCase.GCaseDef;
typedef GCaseCtr            = eu.ohmrun.glot.lang.expr.GCase.GCaseCtr;

typedef GCatch              = eu.ohmrun.glot.lang.expr.GCatch;
typedef GCatchDef           = eu.ohmrun.glot.lang.expr.GCatch.GCatchDef;
typedef GCatchCtr           = eu.ohmrun.glot.lang.expr.GCatch.GCatchCtr;


typedef GComplexType        = eu.ohmrun.glot.lang.expr.GComplexType;
typedef GComplexTypeSum     = eu.ohmrun.glot.lang.expr.GComplexType.GComplexTypeSum;
typedef GComplexTypeCtr     = eu.ohmrun.glot.lang.expr.GComplexType.GComplexTypeCtr;

typedef GConstant           = eu.ohmrun.glot.lang.expr.GConstant;
typedef GConstantSum        = eu.ohmrun.glot.lang.expr.GConstant.GConstantSum;
typedef GConstantCtr        = eu.ohmrun.glot.lang.expr.GConstant.GConstantCtr;

typedef GExpr               = eu.ohmrun.glot.lang.expr.GExpr;
typedef GExprSum            = eu.ohmrun.glot.lang.expr.GExpr.GExprSum;
typedef GExprCtr            = eu.ohmrun.glot.lang.expr.GExpr.GExprCtr;

typedef GField              = eu.ohmrun.glot.lang.expr.GField;
typedef GFieldDef           = eu.ohmrun.glot.lang.expr.GField.GFieldDef;
typedef GFieldCtr           = eu.ohmrun.glot.lang.expr.GField.GFieldCtr;


#if (hax_ver > 4.205)
typedef GEFieldKind          = eu.ohmrun.glot.lang.expr.GEFieldKind;
#end

typedef GFieldType          = eu.ohmrun.glot.lang.expr.GFieldType;
typedef GFieldTypeSum       = eu.ohmrun.glot.lang.expr.GFieldType.GFieldTypeSum;
typedef GFieldTypeCtr       = eu.ohmrun.glot.lang.expr.GFieldType.GFieldTypeCtr;

typedef GFunction           = eu.ohmrun.glot.lang.expr.GFunction;
typedef GFunctionDef        = eu.ohmrun.glot.lang.expr.GFunction.GFunctionDef;
typedef GFunctionCtr        = eu.ohmrun.glot.lang.expr.GFunction.GFunctionCtr;

typedef GFunctionKind       = eu.ohmrun.glot.lang.expr.GFunctionKind;

typedef GFunctionArg        = eu.ohmrun.glot.lang.expr.GFunctionArg;
typedef GFunctionArgDef     = eu.ohmrun.glot.lang.expr.GFunctionArg.GFunctionArgDef;
typedef GFunctionArgCtr     = eu.ohmrun.glot.lang.expr.GFunctionArg.GFunctionArgCtr;

typedef GMetadata           = eu.ohmrun.glot.lang.expr.GMetadata;

typedef GMetadataEntry      = eu.ohmrun.glot.lang.expr.GMetadataEntry;
typedef GMetadataEntryDef   = eu.ohmrun.glot.lang.expr.GMetadataEntry.GMetadataEntryDef;
typedef GMetadataEntryCtr   = eu.ohmrun.glot.lang.expr.GMetadataEntry.GMetadataEntryCtr;

typedef GObjectField        = eu.ohmrun.glot.lang.expr.GObjectField;
typedef GObjectFieldDef     = eu.ohmrun.glot.lang.expr.GObjectField.GObjectFieldDef;
typedef GObjectFieldCtr     = eu.ohmrun.glot.lang.expr.GObjectField.GObjectFieldCtr;

typedef GPropAccess         = eu.ohmrun.glot.lang.expr.GPropAccess;
typedef GPropAccessSum      = eu.ohmrun.glot.lang.expr.GPropAccess.GPropAccessSum;
typedef GPropAccessCtr      = eu.ohmrun.glot.lang.expr.GPropAccess.GPropAccessCtr;

typedef GQuoteStatus        = eu.ohmrun.glot.lang.expr.GQuoteStatus;

typedef GStringLiteralKind  = eu.ohmrun.glot.lang.expr.GStringLiteralKind;

typedef GTypeDefinition     = eu.ohmrun.glot.lang.expr.GTypeDefinition;
typedef GTypeDefinitionDef  = eu.ohmrun.glot.lang.expr.GTypeDefinition.GTypeDefinitionDef;
typedef GTypeDefinitionCtr  = eu.ohmrun.glot.lang.expr.GTypeDefinition.GTypeDefinitionCtr;

typedef GTypeDefKind        = eu.ohmrun.glot.lang.expr.GTypeDefKind;
typedef GTypeDefKindSum     = eu.ohmrun.glot.lang.expr.GTypeDefKind.GTypeDefKindSum;
typedef GTypeDefKindCtr     = eu.ohmrun.glot.lang.expr.GTypeDefKind.GTypeDefKindCtr;

typedef GTypeParam          = eu.ohmrun.glot.lang.expr.GTypeParam;
typedef GTypeParamSum       = eu.ohmrun.glot.lang.expr.GTypeParam.GTypeParamSum;
typedef GTypeParamCtr       = eu.ohmrun.glot.lang.expr.GTypeParam.GTypeParamCtr;

typedef GTypeParamDecl      = eu.ohmrun.glot.lang.expr.GTypeParamDecl;
typedef GTypeParamDeclDef   = eu.ohmrun.glot.lang.expr.GTypeParamDecl.GTypeParamDeclDef;
typedef GTypeParamDeclCtr   = eu.ohmrun.glot.lang.expr.GTypeParamDecl.GTypeParamDeclCtr;

typedef GTypePath           = eu.ohmrun.glot.lang.expr.GTypePath;
typedef GTypePathDef        = eu.ohmrun.glot.lang.expr.GTypePath.GTypePathDef;
typedef GTypePathCtr        = eu.ohmrun.glot.lang.expr.GTypePath.GTypePathCtr;

typedef GUnop               = eu.ohmrun.glot.lang.expr.GUnop;
typedef GUnopSum            = eu.ohmrun.glot.lang.expr.GUnop.GUnopSum;

typedef GVar                = eu.ohmrun.glot.lang.expr.GVar;
typedef GVarDef             = eu.ohmrun.glot.lang.expr.GVar.GVarDef;
typedef GVarCtr             = eu.ohmrun.glot.lang.expr.GVar.GVarCtr;
